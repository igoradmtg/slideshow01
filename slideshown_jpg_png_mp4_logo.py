...
dirMusic = [r"Z:\music\muz4"] # Каталог с файлами музыка
fileNameMp3 = r"output.m4a" # Файл для добавления звука
dirNameOut = r"W:\001\Out_slide"
timeSeconds = 3 # Просмотр слайдшоу в секундах на 1 фото
reklamTexts = [
    "t.me/lsmmag",
    "t.me/lsmag",
    "t.me/pinkstreetgirls",
    "t.me/teenagemg",
    "t.me/teensus",
    "t.me/lsmagza",
    "t.me/lsmagz",
...
maxWidth = 420 # Ширина видео
maxHeight = 420 # Высота видео
...
def saveImagePng(imageJpg,imagePng,reklamText,reklamFontSize):
    ...
    try:    
        imgBg = original.filter(ImageFilter.GaussianBlur(radius = 10)) 
...
def saveAllFilesJPGtoPNG(dirNameFiles):
    ...
    for dirName in listDirs:
        ...
        for dirName2 in listDirs2:
            ...
            os.system("ffmpeg -y -r 1/"+str(timeSeconds)+" -i "+dirNameOut+"\\%05d.png -c:v libx264 -preset medium -b:v 8192k -maxrate 8192k -bufsize 8192k -vf \"fps=25,format=yuv420p\" "+fullNameOut) # Конвертировать в MP4
            os.system("del /Q "+dirNameOut+"\\*.png") # Delete all files in a directory
...
if __name__ == '__main__':
    ...
    reklamFontSize = int(sys.argv[3]) # Размер шрифта рекламного текста
